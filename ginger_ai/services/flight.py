...
class FlightIntegration:
    ...
    async def search_family_friendly_flights(self, search: FlightSearch) -> List[Dict]:
        ...
        return self._merge_and_filter_results(
            amadeus_results, skyscanner_results, family_friendly_only=True
        )
    ...
    def integrate_with_calendar(
        self, flight_options: List[Dict], calendar_events: List[Dict]
    ) -> List[Dict]:
                ...
                trips.append(
                    {
                        ...
                        "family_friendly_score": self._calculate_family_score(
                            dest, flights
                        ),
                    }
                )
